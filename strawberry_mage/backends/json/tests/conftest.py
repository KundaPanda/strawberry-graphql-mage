...
from strawberry_mage.backends.json.tests.example_app.schema import *
from strawberry_mage.backends.json.tests.example_app.schema import schema as strawberry_schema
