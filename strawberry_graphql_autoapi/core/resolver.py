...
def resolver_query_one(model: Type[IEntityModel]):
    ...
    def query_one(info: Info, data: data_type = UNSET) -> return_type:
        return model.resolve(GraphQLOperation.QUERY_ONE, info, data)
...
def resolver_query_many(model: Type[IEntityModel]):
    ...
    def query_many(info: Info, data: Optional[data_type] = UNSET) -> return_type:
        return model.resolve(GraphQLOperation.QUERY_MANY, info, data)
...
def resolver_create_one(model: Type[IEntityModel]):
    ...
    def create_one(info: Info, data: data_type) -> return_type:
        return model.resolve(GraphQLOperation.CREATE_ONE, info, data)
...
def resolver_create_many(model: Type[IEntityModel]):
    ...
    def create_many(info: Info, data: data_type) -> return_type:
        return model.resolve(GraphQLOperation.CREATE_MANY, info, data)
...
def resolver_update_one(model: Type[IEntityModel]):
    ...
    def update_one(info: Info, data: data_type) -> return_type:
        return model.resolve(GraphQLOperation.UPDATE_ONE, info, data)
...
def resolver_update_many(model: Type[IEntityModel]):
    ...
    def update_many(info: Info, data: data_type) -> return_type:
        return model.resolve(GraphQLOperation.UPDATE_MANY, info, data)
...
def resolver_delete_one(model: Type[IEntityModel]):
    ...
    def delete_one(info: Info, data: data_type) -> DeleteResult:
        return model.resolve(GraphQLOperation.DELETE_ONE, info, data)
...
def resolver_delete_many(model: Type[IEntityModel]):
    ...
    def delete_many(info: Info, data: data_type) -> DeleteResult:
        return model.resolve(GraphQLOperation.DELETE_MANY, info, data)
